...
- Vision-based Structural Health Monitoring (SHM)  
- Embedded sensing systems (ESP32, IoT)  
...
- Subpixel accuracy for micro-displacement detection  
- Embedded data acquisition using ESP32-CAM  
...
- **M.I.S.S System**  
  Micro image strain sensing system using ESP32-CAM  

- **ESP32 Real-Time Monitoring Dashboard**  
  Flask-based dashboard for embedded monitoring systems  

---

## Portfolio

🌐 https://kwakuanimasare.surge.sh
